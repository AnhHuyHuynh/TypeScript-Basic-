...
export class QuanLyHang {
    ...
    private hang: sanPham[] = []; // dùng để nhận dữ liệu từ api

    constructor() {

        // vì không có php nên sẽ tạo data tĩnh(tạo băng tay)
        var sanpham1 = new sanPham(1,"Mô Hình Naruto NA01041",
                       19000, "Thích hợp để bàn, sưu tập, hoặc làm quà tặng",false,"3.jpg");
        this.addSanPham(sanpham1);

        var sanpham2 = new sanPham(2,"Mô Hình Pain thiên đạo PA01041",
                        279000, "Thích hợp để bàn, sưu tập, hoặc làm quà tặng",true,"4.jpg");
        this.addSanPham(sanpham2);

        var sanpham3 = new sanPham(3,"Mô hình Naruto Hokage Đệ Nhị Senju Tobirama",
                       179000, "Thích hợp để bàn, sưu tập, hoặc làm quà tặng",true,"5.jpg");
        this.addSanPham(sanpham3);

        var sanpham4 = new sanPham(4,"Mô Hình Madara Naruto NA01026",
        199000, "Thích hợp để bàn, sưu tập, hoặc làm quà tặng",true,"1.jpg");
        this.addSanPham(sanpham4);

        var sanpham5 = new sanPham(5,"Mô Hình Hokage dệ nhât Senju Hasirama",
        210000, "Thích hợp để bàn, sưu tập, hoặc làm quà tặng",true,"2.jpg");
    ...
    public getsanphamByID(idsanpham:number):any  {
        ...
        for (let i:number= 0;i< this.hang.length ;i++) {
